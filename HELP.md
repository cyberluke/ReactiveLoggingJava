...
* The original package name 'github.cyberluke.reactive-logging' is invalid and this project uses 'github.cyberluke.reactive_logging' instead.
...
```
$ docker run --rm reactive-logging:0.0.1-SNAPSHOT
```
